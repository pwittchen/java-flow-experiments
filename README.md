...
- `presentation` (temporary deleted due to config updates) branch contains code snippets for Java 8 shown during the presentation and empty project in Java 9 for live coding
